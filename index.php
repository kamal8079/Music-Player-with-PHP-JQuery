...
<head>
    ...
    <title>Lofi - Relaxing Music</title>
...
<main>
    ...
    <body>
        ...
        <nav>
            <ul>
                <li class="brand"><img src="logo/logo.jpg" alt="Error 404">LOFI-MUSIC</li>
                <li>Home</li>
                <li>Search</li>
                <li>About</li>
                <li>Help</li>
        ...
        <div class="container">
            <div class="songList">
                <h1>BEST LOFI YOU WILL LOVE....</h1>
                <button class="btn btn-primary rounded-0 btn-sm" data-bs-toggle="modal"
                        data-bs-target="#music_modal" type="button"><i class="fa fa-plus"></i> Add</button>
                <div class="songItemConatainer">
